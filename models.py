...
FUNDAMENTAL_PITCH_TO_NOTES_MAP = OrderedDict()
for _notes, _pitch in PITCHES.items():
    FUNDAMENTAL_PITCH_TO_NOTES_MAP[_pitch] = _notes.split('/')
# This results in a reverse dictionary that looks like:
# {
